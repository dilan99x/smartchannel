...
<script>
	function updateChannelCenter() {
		...
		if (doctorId == null || doctorId == "") {
			...
			$.getJSON('ajax/updateDoctor.action?doctorId=' + doctorId + '&firstName=' + firstName + '&lastName='
					+ lastName + '&nameWithInnitials=' + nameWithInnit + '&registrationNumber=' + regNo + '&nic='
					+ doctorNic + '&age=' + age + '&address=' + address + '&description=' + description + '&isActive='
					+ activeStatus + '&email=' + email + '&web=' + doctorWeb + '&mobile=' + mobileNumber
			...
			<div id="content_bar">
					...
					<div id="wrapper">
						...
						<ul class="leftmenu">
							...
							<li class="item5"><a href="#">Reports</a>
								<ul>
									<li class="subitem1"><a href="testReportDisplay">Test Report<span>14</span></a></li>
									<li class="subitem2"><a href="#">Strange “Stuff” <span>6</span></a></li>
									<li class="subitem3"><a href="#">Automatic Fails <span>2</span></a></li>
								</ul>
							</li>
				...
				<div id="right_bar">
					<form id="doctorRegistrationForm" action="doctorSupport!addDoctor.action" method="post">
						<table>
							<tr>
								...
								<td>&emsp;</td>
								<td>Email</td>
								<td><s:textfield id="doctor_email" name="email" required="true" label="" theme="simple"></s:textfield></td>
							</tr>
							<tr>
								<td>Last Name</td>
								...
								<td>&emsp;</td>
								<td>Web</td>
								<td><s:textfield id="doctor_web" name="web" label="" theme="simple"></s:textfield></td>
							</tr>
							<tr>
								<td>Name with Innitials</td>
								<td><s:textfield id="doctor_innitname" name="nameWithInnitials" label="" required="true" theme="simple"></s:textfield></td>
								<td>&emsp;</td>
								<td>Mobile No</td>
								<td><s:textfield id="doctor_mobile_no" name="mobile" label="" required="true" theme="simple"></s:textfield></td>
							</tr>
							<tr>
								<td>NIC</td>
								...
								<td>&emsp;</td>
								<td>Resience No</td>
								<td><s:textfield id="doctor_residence_no" name="residence" label="" theme="simple"></s:textfield></td>
							</tr>
							<tr>
								<td>Age</td>
								<td><s:textfield id="doctor_age" name="age" label="" theme="simple"></s:textfield></td>
								<td>&emsp;</td>
								<td>Reg No</td>
								<td><s:textfield id="doctor_reg_no" name="registrationNumber" label="" required="true" theme="simple"></s:textfield></td>
							</tr>
							<tr>
								<td>Address</td>
								<td><s:textfield id="doctor_address" name="address" label="" required="true" theme="simple"></s:textfield></td>
								<td>&emsp;</td>
								<td colspan="2"><s:file name="imageFile" theme="simple" id="doctor_file"></s:file></td>
							</tr>
							<tr>
								<td>Description</td>
								<td><s:textarea id="doctor_desc" name="description" label="Description" rows="3" cols="30" theme="simple"></s:textarea></td>
								<td>&emsp;</td>
								<td colspan="2">&emsp;&emsp;&emsp;<input type="submit" value="Save" /> <input type="button" value="Update"
									onclick="updateChannelCenter()" /> <input type="button" value="Delete"
									onclick="channelCenterRegisterFormSubmit('deleteDoctor.action')" /> <input type="button" value="Clear"
									onclick="makeClear()" /></td>

							</tr>
							<tr>
								<td>Active Status</td>
								<td><s:radio id="doctor_active_status" name="isActive" list="#{'1':'Y','0':'N'}" value="1"
										label="Active Status" theme="simple"></s:radio></td>
								<td>&emsp;</td>
								<td></td>
							</tr>
							<tr>
								<td><input type="hidden" id="doctor_id" name="doctorId" value="<s:property value="doctorId"/>" /></td>
							</tr>
						</table>
					</form>
					</br> </br>
					<div class="table-wrapper">
						<table class="data">
							<tr>
								<td class="cs_save_grid">First Name</td>
								<td class="cs_save_grid">Last Name</td>
								<td class="cs_save_grid">Name with innit</td>
								<td class="cs_save_grid">NIC</td>
								<td class="cs_save_grid">Age</td>
								<td class="cs_save_grid">Address</td>
								<td class="cs_save_grid">Description</td>
								<td class="cs_save_grid">Mobile No</td>
								<td class="cs_save_grid">Residence No</td>
								<td class="cs_save_grid">Email</td>
								<td class="cs_save_grid">Web</td>
								<td class="cs_save_grid">Reg No</td>
							</tr>
							...
							<s:iterator value="doctorList">
								<tr>
									...
									<td class="dynamic_grid"><input id="rdg_1_age<s:property value="doctorId" />" class="dynamic_grid"
										type="text" value="<s:property 
										value="age" />" /></td>

									<td class="descriptive_col"><input id="rdg_1_address<s:property value="doctorId" />"
										class="descriptive_col" type="text" value="<s:property 
										value="address" />" /></td>

									<td width="200" class="descriptive_col"><input id="rdg_1_desc<s:property value="doctorId" />"
										class="descriptive_col" type="text" value="<s:property
										value="description" />" /></td>

									<td class="dynamic_grid"><input id="rdg_1_mobile<s:property value="doctorId" />" class="dynamic_grid"
										type="text" value="<s:property 
										value="mobile" />" /></td>

									<td class="dynamic_grid"><input id="rdg_1_residence<s:property value="doctorId" />" class="dynamic_grid"
										type="text" value="<s:property 
										value="residence" />" /></td>

									<td class="dynamic_grid"><input id="rdg_1_email<s:property value="doctorId" />" class="dynamic_grid"
										type="text" value="<s:property 
										value="email" />" /></td>

									<td class="dynamic_grid"><input id="rdg_1_web<s:property value="doctorId" />" class="dynamic_grid"
										type="text" value="<s:property 
										value="web" />" /></td>

									<td class="dynamic_grid"><input id="rdg_1_regno<s:property value="doctorId" />" class="dynamic_grid"
										type="text" value="<s:property 
										value="registrationNumber" />" /></td>
									...
									<td class="myx"><input class="myx" type="button"
										...
										document.getElementById('rdg_1_nic<s:property value="doctorId" />').value,
										document.getElementById('rdg_1_age<s:property value="doctorId" />').value,
										document.getElementById('rdg_1_address<s:property value="doctorId" />').value,
										document.getElementById('rdg_1_desc<s:property value="doctorId" />').value,
										document.getElementById('rdg_1_mobile<s:property value="doctorId" />').value,
										document.getElementById('rdg_1_residence<s:property value="doctorId" />').value,
										document.getElementById('rdg_1_email<s:property value="doctorId" />').value,
										document.getElementById('rdg_1_web<s:property value="doctorId" />').value,
