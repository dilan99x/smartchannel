						...
						<form action="patientInforSupport!processPatientInfor" method="post">
							...
							<table>
								...
								<tr>
									...
									<td>&emsp;&emsp;&emsp;&emsp;<s:textfield name="clinic.dateFrom" theme="simple" readonly="true" /></td>
								</tr>
								<tr>
									<td>Appointment Time</td>
									<td>&emsp;&emsp;&emsp;&emsp;<s:textfield name="appointmentTime" theme="simple" readonly="true" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>&emsp;&emsp;&emsp;&emsp;<s:textfield name="patientFirstName" theme="simple"  /></td>
								</tr>
								<tr>
									<td>Patient's Last Name</td>
									<td>&emsp;&emsp;&emsp;&emsp;<s:textfield name="patientLastName" theme="simple"  /></td>
								</tr>
								<tr>
									<td>Gender</td>
									<td>&emsp;&emsp;&emsp;&emsp;<s:radio name="patientGender" list="{'Male','Female'}"  id="is_active" theme="simple" /></td>
								</tr>
								<tr>
									<td>Mobile Phone number</td>
									<td>&emsp;&emsp;&emsp;&emsp;<s:textfield name="patientMobileNumber" theme="simple"  /></td>
								</tr>
								<tr>
									<td>Email</td>
									<td>&emsp;&emsp;&emsp;&emsp;<s:textfield name="patientEmail" theme="simple"  /></td>
								</tr>
								<tr>
									<td>Address</td>
									<td>&emsp;&emsp;&emsp;&emsp;<s:textfield name="patientAddress" theme="simple" /></td>
								</tr>
								<tr>
									<td>NIC</td>
									<td>&emsp;&emsp;&emsp;&emsp;<s:textfield name="patientNic" theme="simple"  /></td>
								</tr>
                                <tr>
                                <td></td><td>&emsp;&emsp;&emsp;&emsp;<input type="submit" value="Proceed"/> <input type="button" value="Cancel"/></td>
                                </tr>
                                <tr>
                                <td></td><td> <input type="hidden" name="clinicId" value="<s:property value="clinicId" />"/> 
